...
// (ver semana 04/05/06: .partial() sobre un schema con .default() sigue
// aplicando el default a los campos ausentes, así que los defaults solo
// van en createConcessionSchema)
